...
internal static class Mapping
{
    ...
    {
        return new UserSummaryResponse(user.Id, user.Email, user.DisplayName, user.Gamertag, user.EaSportsId, user.DiscordUserId, (Platform)(int)user.Platform, user.PreferredLanguage, user.TimeZone, user.ProfileImageUrl, user.EaClubId, user.EaClubName);
    }
