...
public sealed class AuthServiceTests
{
    ...
    private static AuthService CreateService(FakeUserRepository? users = null)
    {
    ...
    private sealed class FakeTeamRepository : ITeamRepository
    {
        ...
        public Task AddMemberAsync(TeamMember membership, CancellationToken cancellationToken = default) => Task.CompletedTask;
